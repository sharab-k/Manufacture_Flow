...
for filename in html_files:
    ...
    # The original notification button across all files has whitespace variation but generally looks like this
    # Start at <!-- Notifications -->
    # Then there is a <button> block containing <i class="ph ph-bell text-[20px]"></i>
    # Ended by </button>
    pattern = r'<!-- Notifications -->\s*<button[\s\S]*?<i class="ph ph-bell[\s\S]*?</i>\s*</button>'
